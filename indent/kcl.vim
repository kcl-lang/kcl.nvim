...
setlocal indentexpr=GetKCLIndent()
setlocal indentkeys=0{,0},0),0[,0],!^F,o,O,e

" Only define the function once.
if exists("*GetKCLIndent")
  finish
endif
...
function s:IsInString(lnum, col)
  return synIDattr(synID(a:lnum, a:col, 1), 'name') == "KCLString"
endfunction
...
" 3. GetKCLIndent Function {{{1
" =========================

function GetKCLIndent()
  " 3.1. Setup {{{2
  " ----------
